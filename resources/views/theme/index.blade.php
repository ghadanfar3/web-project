                ...
                @foreach($sliderBlogs as $blog)
                    <div class="card blog__slide text-center">
                        ...
                        <div class="blog__slide__content">
                            <a class="blog__slide__label" href="{{route('category' , $blog->category->id)}} ">{{$blog->category->name}}</a>
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="single-recent-blog-post">
                            <div class="thumb">
                                ...
                                <ul class="thumb-info">
                                    <li><a href="{{route('user.blogs' , $blog->user)}}"><i class="ti-user"></i>{{$blog->user->name}}</a></li>
